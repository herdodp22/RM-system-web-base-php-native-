      ...
      <div style="display: flex; justify-content: center;flex-direction: column;">
        ...
        <table border="1" style="margin:10px; padding: 10px;text-align: center;">
          ...
          <?php 
              ...
              $namapasien1 = $_GET['namapasien'];
              $caripasien = "SELECT * FROM informasipasien WHERE nama_pasien = '$namapasien1'";
              $hubungkancaripasien = mysqli_query($koneksi, $caripasien);
              while($ambildatapasien = mysqli_fetch_array($hubungkancaripasien)){
                      $idpasien = $ambildatapasien['id_pasien'];
                ...
                ?>
                      <tr>
                        ...
                        <td><a href="daftartunggu.php?idpasien=<?php echo $idpasien; ?>">Ajukan</a></td>
                      </tr>
              <?php 
              }
               ?>
